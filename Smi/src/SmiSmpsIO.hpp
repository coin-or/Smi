...
enum SmiSmpsType
{
	...
	SMI_COLUMN_CARD,
	SMI_DISCRETE_DIST,
	SMI_SMPS_COMBINE_ADD,
	SMI_SMPS_COMBINE_REPLACE,
	SMI_SMPS_COMBINE_UNKNOWN,
	SMI_UNKNOWN_MPS_TYPE,
	SMI_TIME_UNORDERED_CORE_TYPE,
...
public:
	  ...
	  SmiSmpsCardReader( CoinFileInput *input, CoinMpsIO * reader ) :
		  ...
		  fvalue_(0.0),
		  smiSection_(SMI_NO_SECTION),
		  smiSmpsType_(SMI_SC_CARD),
		  combineRule_(NULL),
